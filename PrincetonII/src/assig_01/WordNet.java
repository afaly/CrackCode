...
public class WordNet {
    ...
    public WordNet(String synsets, String hypernyms) {
        ...
        if (!checkRoot()) throw new IllegalArgumentException("Not a valid DAG");
    ...
    private boolean checkRoot() {
        int cnt = 0;
        for (int node = 0; node < wordnet.V(); node++)
    ...
    private void readHypernyms(String hypernyms) {
        ...
        while (read.hasNextLine()) {
            String[] data = read.readLine().split(",");
            int src = Integer.parseInt(data[0]), dst;
    ...
    public static void main(String[] args) {
        String s = "wordnet/synsets3.txt";
        String h = "wordnet/hypernyms3InvalidCycle.txt";
