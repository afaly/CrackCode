...
public class BellmanFordTest {
	...
	public void testBellmanFordWithPositiveEdges() throws Exception {
		...
		Integer[][] weight = { { null, 10, null, null, 3 },
				{ null, null, 2, null, 1 }, { null, null, null, 7, null },
				{ null, null, 9, null, null }, { null, 4, 8, 2, null } };
		int source = 0;
	...
	public void testBellmanFordWithNegativeEdges() throws Exception {
		System.out.println("singleSourceShortestPath");
		Integer[][] weight = { { null, -1, 4, null, null },
				{ null, null, 3, 2, 2 }, { null, null, null, null, null },
				{ null, 1, 5, null, null }, { null, null, null, -3, null } };
		int source = 0;
		BellmanFord instance = new BellmanFord();
	...
	public void testBellmanFordWithNegativeCycle() {
		System.out.println("singleSourceShortestPath");
		Integer[][] weight = { { null, -1, 4, null, null },
				{ null, null, 3, 2, 2 }, { null, -6, null, null, null },
				{ null, 1, 5, null, null }, { null, null, null, -3, null } };
		int source = 0;
		BellmanFord instance = new BellmanFord();
		try {
