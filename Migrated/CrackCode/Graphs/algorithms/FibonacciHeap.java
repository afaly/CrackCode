...
public final class FibonacciHeap<T> {
	...
	public void decreaseKey(Entry<T> entry, double newPriority) {
		...
		if (newPriority > entry.mPriority) throw new IllegalArgumentException(
				"New priority exceeds old.");
	...
	private void checkPriority(double priority) {
		if (Double.isNaN(priority)) throw new IllegalArgumentException(priority
				+ " is invalid.");
	}
