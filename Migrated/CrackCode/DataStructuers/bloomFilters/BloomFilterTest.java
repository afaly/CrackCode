...
public class BloomFilterTest {
	...
	public void testEquals() throws UnsupportedEncodingException {
		...
		instance1.add("Another entry"); // make instance1 and instance2
										// different before clearing
	...
	public void testExpectedFalsePositiveProbability() {
		// These probabilities are taken from the bloom filter probability table
		// at
	...
	public void testFalsePositiveRate1() throws UnsupportedEncodingException {
		...
		for (int j = 10; j < 21; j++) {
			...
			BloomFilter instance = new BloomFilter<Object>(100 * j, 100);
			...
			System.out.println(" - got " + ratio + ", math says "
					+ instance.expectedFalsePositiveProbability());
			assertEquals(instance.expectedFalsePositiveProbability(), ratio,
					0.01);
		}
	}
