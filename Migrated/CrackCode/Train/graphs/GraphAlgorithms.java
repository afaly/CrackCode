...
public class GraphAlgorithms {
	...
	public static final String urlStrTiny = "http://algs4.cs.princeton.edu/44sp/tinyEWD.txt";
	public static final String urlStrMed = "http://algs4.cs.princeton.edu/44sp/mediumEWD.txt";
	public static final String urlStrHuge = "http://algs4.cs.princeton.edu/44sp/largeEWD.txt";

	public static final String urlKRUTiny = "http://algs4.cs.princeton.edu/43mst/tinyEWG.txt";
	public static final String urlKRUMed = "http://algs4.cs.princeton.edu/43mst/mediumEWG.txt";
	public static final String urlKRUHuge = "http://algs4.cs.princeton.edu/43mst/largeEWG.txt";
	...
	public static void main(String[] args) throws IOException {
		...
		for (int i = 1; i <= M; i++) {
			...
			if (val > percent) {
				percent = val;
				// System.out.println("Done Percentage: " + percent + "  %");
			}
		...
		// g.Dijkstra(0);
		// System.out.println(Arrays.toString(g.getDijstraDistances(0)));
		// System.out.println("-------------------------------------");
		// Map<Integer, LinkedList<Integer>> paths = g.getDijstraPaths(0);
		// for (Integer dst : paths.keySet()) {
		// System.out.println(paths.get(dst));
		// }

		AdjList[] t1 = g.PrimMST(0);
